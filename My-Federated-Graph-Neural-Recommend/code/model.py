    ...
    def forward(self, user_ids, item_ids, history=None, neighbor_emb=None):
        ...
        if history is not None and neighbor_emb is not None:
            ...
            if neighbor_emb.dim() < 4:
                # Fill missing neighbor embeddings with default values (e.g., mean value)
            ...
            # If history and neighbor embeddings are not provided, use only user and item embeddings
